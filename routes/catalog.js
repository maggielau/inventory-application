...
// GET request for all products in JSON format.
router.get('/products-api', product_controller.product_list_api);
...
// GET request for all categories in JSON format.
router.get('/categories-api', category_controller.category_list_api);
